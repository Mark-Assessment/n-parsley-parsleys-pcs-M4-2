...
Please see below a copy of the previous table with an additional column depicting whether the user story was met or not.

Unfortunately, some features such as User Reviews and the interactive PC Builder were not added due to time constraints.

| **ID** | **As** | **I want to be able to** | **In order to** | **User Story Met?** |
|:---:|:---:|:---:|:---:|---|
| **1** | **Guest User** | View the site irrespective of the browser/device I am using | Be able to view all required information | :white_check_mark: |
| **2** | **Guest User** | View the site's available products and their information | View the purchasable items | :white_check_mark: |
| **3** | **Guest User** | Sort the site's shop by order of popularity | View the most popular items first | :white_check_mark: |
| **4** | **Guest User** | Sort the items by their specific category | View the items I am most interested in buying | :white_check_mark: |
| **5** | **Guest User** | Add items to my cart | Purchase my chosen items and view a running total spend | :white_check_mark: |
| **6** | **Guest User** | Remove items from my cart | Cancel a purchase on a specific item | :white_check_mark: |
| **7** | **Guest User** | Create an account | Have a personalised shopping experience and saved information | :white_check_mark: |
| **8** | **Guest User** | View each product in detail | Gain more insight into a specific product before purchase | :white_check_mark: |
| **9** | **Guest User** | Interactively build my own PC | Gain an idea as to what the final product would be | :x: |
| **10** | **Guest User** | View featured or reduced deals | Get the best deals available on the site | :white_check_mark: |
| **11** | **Guest User** | Search for products on the site | Find a specific item | :white_check_mark: |
| **12** | **Guest User** | View related products to the one I am looking at | Find potentially better deals or suitability and compare the results | :x: |
| **13** | **Guest User** | View my current search and how many results were returned | Gain an insight into the usefulness of the search | :white_check_mark: |
| **14** | **Guest User** | Easily update the items/quantity in my shopping bag | Make changes to my purchases | :white_check_mark: |
| **15** | **Guest User** | Input my payment details when confirming a purchase | Pay for the items in my shopping bag | :white_check_mark: |
| **16** | **Guest User** | Receive a confirmation email after placing an order (with option to provide email address) | Have peace of mind that my order was received | :white_check_mark: |
| **17** | **Registered User** | Manage my account, such as username, address or name | Be able to keep my information up to date | :white_check_mark: |
| **18** | **Registered User** | Change or reset my password | Access my account if the password is forgotten or stolen | :white_check_mark: |
| **19** | **Registered User** | Delete my account | Remove my personal information from the site | :x: |
| **20** | **Registered User** | Add a review to an item | Provide feedback for the store owner and for other shoppers | :x: |
| **21** | **Registered User** | Save my delivery address for further potential purchases | Have an easy experience if I return to the site | :white_check_mark: |
| **22** | **Registered User** | Delete a review I have previously posted | Remove my opinion from the product | :x: |
| **23** | **Registered User** | Update or edit a review posted by myself | Change a potential mistake in my review | :x: |
| **24** | **Site Admin** | Add an item to the store along with a picture | Add fresh or updated products to the store | :white_check_mark: |
| **25** | **Site Admin** | Update an items on the store | Change the price or add more information such as an updated picture | :white_check_mark: |
| **26** | **Site Admin** | Remove or hide items from the store  | Control what is available on the store currently | :white_check_mark: |
| **27** | **Site Admin** | Update the site's terms and conditions, or other information such as banners | Ensure customers are updated on potential issues or specific sales | :x: |
| **28** | **Site Admin** | Add/Remove/Update categories of items | Ensure that there is a category readily available and suitable for each product | :white_check_mark: |
